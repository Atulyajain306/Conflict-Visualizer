...
const Europe = () => { 
     const [govSpending, setgovSpending] = useState('UK')
     const [govSpendingData, setgovSpendingData] = useState(govData['UK'])
     const [country, setcountry] = useState('UK')
     const [data, setdata] = useState(countryList["UK"])
     const changevalue=(e)=>{
    ...
    <div>
      <Navbar/>
         <select value={country} onChange={changevalue}  className='m-4 mx-60 px-5 py-3 w-48 bg-slate-200 rounded-xl ' >
            ...
            <option value="Lathvia">Lathvia</option>
