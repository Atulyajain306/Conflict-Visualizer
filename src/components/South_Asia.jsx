...
const South_Asia = () => {
    const [govSpending, setgovSpending] = useState('India')
    const [govSpendingData, setgovSpendingData] = useState(govData['India'])
    const [country, setcountry] = useState('India')
    const [data, setdata] = useState(countryList['India'])
    const changevalue=(e)=>{
