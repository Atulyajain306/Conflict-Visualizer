...
const North_America = () => {
    const [govSpending, setgovSpending] = useState('Canada')
    const [govSpendingData, setgovSpendingData] = useState(govData['Canada'])
    const [country, setcountry] = useState('Canada')
    const [data, setdata] = useState(countryList['Canada'])
    const changevalue=(e)=>{
